...
REM
REM  Location: instances/tscg-tools/TscgPocletExplorer/
REM  Usage   : double-click this file, or call from any folder
REM
REM  Remonte 3 niveaux jusqu'a la racine tscg/ pour executer
REM  "npm run sim;TscgPocletExplorer" depuis le bon package.json
REM  TscgPocletExplorer\ -> tscg-tools\ -> instances\ -> tscg\
REM ================================================================
...
echo [TSCG] Launching : npm run sim:TscgPocletExplorer
echo.
 
npm run sim:TscgPocletExplorer
