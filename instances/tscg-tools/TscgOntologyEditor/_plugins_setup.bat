...
set PLUGINS_DIR=%LOCALAPPDATA%\TscgOntologyEditor\plugins

echo.
echo === TscgOntologyEditor - Dev Plugins Setup ===
...
xcopy /E /I /Y dev\tscg-python-bridge "%PLUGINS_DIR%\tscg-python-bridge" >nul
