// =============================================================
// TscgOntologyEditor — src/config/ConfigManager.js   (CJS)
// Reads and writes config.json in AppData\Local\TscgOntologyEditor\.
...
const DEFAULTS = {
  ...
  // Cached from M0_TscgOntologyEditor.jsonld (single source of truth)
...
// ── Layer paths helper ────────────────────────────────────────
// Reads m0:preconfiguredPaths from M0_TscgOntologyEditor.jsonld.
