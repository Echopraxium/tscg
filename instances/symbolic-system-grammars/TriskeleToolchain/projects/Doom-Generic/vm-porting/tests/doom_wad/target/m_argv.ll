; ModuleID = 'E:\_00_Michel\_00_Lab\_00_GitHub\tscg\instances\symbolic-system-grammars\TriskeleToolchain\projects\Doom-Generic/vm-porting/tests/doom_wad\src/m_argv.c'
source_filename = "E:\\_00_Michel\\_00_Lab\\_00_GitHub\\tscg\\instances\\symbolic-system-grammars\\TriskeleToolchain\\projects\\Doom-Generic/vm-porting/tests/doom_wad\\src/m_argv.c"
...
@myargc = dso_local global i32 0, align 4
@myargv = dso_local global ptr null, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @M_CheckParmWithArgs(ptr noundef %0, i32 noundef %1) #0 {
...
13:                                               ; preds = %7
  %14 = load ptr, ptr @myargv, align 8
  %15 = load i32, ptr %6, align 4
  %16 = sext i32 %15 to i64
  %17 = getelementptr inbounds ptr, ptr %14, i64 %16
  %18 = load ptr, ptr %17, align 8
  %19 = load ptr, ptr %5, align 8
  %20 = call i32 @_stricmp(ptr noundef %19, ptr noundef %18)
  %21 = icmp ne i32 %20, 0
...
declare dso_local i32 @_stricmp(ptr noundef, ptr noundef) #1

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @M_ParmExists(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = call i32 @M_CheckParm(ptr noundef %3)
  %5 = icmp ne i32 %4, 0
  %6 = zext i1 %5 to i32
  ret i32 %6
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @M_CheckParm(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = call i32 @M_CheckParmWithArgs(ptr noundef %3, i32 noundef 0)
  ret i32 %4
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @M_FindResponseFile() #0 {
...
2:                                                ; preds = %19, %0
  ...
  %4 = load i32, ptr @myargc, align 4
  %5 = icmp slt i32 %3, %4
  br i1 %5, label %6, label %22

6:                                                ; preds = %2
  %7 = load ptr, ptr @myargv, align 8
...
16:                                               ; preds = %6
  ...
  call void @LoadResponseFile(i32 noundef %17)
  br label %18
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @LoadResponseFile(i32 noundef %0) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @M_GetExecutableName() #0 {
  %1 = alloca ptr, align 8
  %2 = alloca ptr, align 8
  %3 = load ptr, ptr @myargv, align 8
  %4 = getelementptr inbounds ptr, ptr %3, i64 0
  %5 = load ptr, ptr %4, align 8
  %6 = call ptr @strrchr(ptr noundef %5, i32 noundef 92) #4
...
9:                                                ; preds = %0
  %10 = load ptr, ptr @myargv, align 8
...
!1 = !DIFile(filename: "E:\\_00_Michel\\_00_Lab\\_00_GitHub\\tscg\\instances\\symbolic-system-grammars\\TriskeleToolchain\\projects\\Doom-Generic/vm-porting/tests/doom_wad\\src\\m_argv.c", directory: "E:\\_00_Michel\\_00_Lab\\_00_GitHub\\tscg\\instances\\symbolic-system-grammars\\TriskeleToolchain")
