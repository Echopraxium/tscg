#!/usr/bin/env python3
"""
TSCG Automated Realignment Script - All Instance Types (v3.1.0)
Author: Echopraxium with the collaboration of Claude AI
Date: 2026-04-19 (v2.5.0), 2026-04-20 (v2.6.0, v2.7.0), 2026-05-29 (v3.0.0)
Version: 3.1.0 - Moved to cli-tools/check-M0/, SHACL co-located
...
# v3.1.0: SHACL schema co-located in cli-tools/check-M0/ (same folder as this script)
_SCRIPT_DIR = Path(__file__).parent.resolve()
SHACL_SCHEMA = _SCRIPT_DIR / "M0_Instances_Schema.shacl.ttl"
if not SHACL_SCHEMA.exists():
    # Fallback: search common locations
    for candidate in [
        ONTOLOGY_DIR / "TSCG_InstanceGrammar/M0_Instances_Schema.shacl.ttl",
