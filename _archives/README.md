...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18471859.svg)](https://doi.org/10.5281/zenodo.18471859) 
...
**Research article (v6.0 — published):**
📄 [Zenodo Preprint (latest version)](https://doi.org/10.5281/zenodo.18471859) — Complete M3→M2→M1→M0 architecture, Structural Grammar foundation, 33 validated instances (~11,500 words)
...
- **Research Article (latest, v6.0)**: https://doi.org/10.5281/zenodo.18471859
...
**Framework Status:** Active development — v6.0 research article published (Jun 2026)
