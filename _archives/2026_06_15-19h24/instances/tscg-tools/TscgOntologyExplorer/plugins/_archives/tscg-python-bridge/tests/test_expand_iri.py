"""
test_expand_iri.py — Unit tests for _expand_iri (bridge_server.py).
...
from bridge_server import _expand_iri
...
class TestStrategy2SharedNamespace:
    ...
    def test_chemistry_dotted_prefix(self):
        """m1.ext:chemistry:Foo with ctx key m1.ext:chemistry:chemistry."""
        CHEM_URI = 'https://raw.githubusercontent.com/Echopraxium/tscg/main/ontology/M1_extensions/chemistry/M1_Chemistry.jsonld#'
    ...
    def test_strategy2_does_not_match_unrelated(self):
        ...
        ctx = {'m1.ext:chemistry:chemistry':
               'https://example.com/chemistry#'}
        # m1.ext:biology:Foo should NOT match m1.ext:chemistry context
        result = _expand_iri('m1.ext:biology:Cell', ctx, '')
        # Falls through to Strategy 3 (@base) or returns as-is
...
class TestEdgeCases:
    ...
    def test_https_iri_unchanged(self):
        iri = 'https://raw.githubusercontent.com/Echopraxium/tscg/main/ontology/M2.jsonld#Process'
        assert _expand_iri(iri, {}, BASE) == iri
    ...
    def test_empty_context_uses_base(self):
        ...
        # No m2 in context → base fallback
    ...
    def test_prefix_with_empty_uri_skipped(self):
        ...
        # Empty prefix skipped → base fallback
