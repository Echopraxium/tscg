...
## 🔭 T — First Primitive of Gs

**T (Temporality)** is the first and currently only primitive of 𝕋₀(|):
...
|---|---|---|---|
| `EmptyStereopsis` | Neutral of \| | **Divergent Strabismus** — both eyes look in opposite directions, no fusion possible | max |
| `StereopsisUniversalSet` | Semantic limit | **Convergent Strabismus** — both eyes converge perfectly, Map = Territory (Borges 1:1 map) | 0 |

```
EmptyStereopsis       =  EmptyTerritory | EmptyMap  (δ₁ = max)
StereopsisUniversalSet                               (δ₁ = 0)
```
...
3. **T (Temporality)** — first primitive of 𝕋₀(|), irreducible and genuinely new
4. **| is universal** — operates across all three grammars, always produces Gs types
5. **Divergent/Convergent Strabismus** — documentation metaphors for EmptyStereopsis
   and StereopsisUniversalSet
6. **Corpus-driven discovery** — further Gs primitives will emerge from poclet
   analysis, not systematic search
